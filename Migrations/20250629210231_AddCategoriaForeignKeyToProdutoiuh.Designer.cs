...
namespace API_Pdv.Migrations
{
    ...
    [Migration("20250629210231_AddCategoriaForeignKeyToProdutoiuh")]
    partial class AddCategoriaForeignKeyToProdutoiuh
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_Pdv.Entities.Funcionario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Ativo")
                        .HasDatabaseName("idx_funcionario_ativo");

                    b.HasIndex("CPF")
                        .HasDatabaseName("idx_funcionario_cpf");

                    b.HasIndex("Email")
                        .HasDatabaseName("idx_funcionario_email");

                    b.HasIndex("EmpresaId")
                        .HasDatabaseName("idx_funcionario_empresa");

                    b.HasIndex("Nome")
                        .HasDatabaseName("idx_funcionario_nome");
            ...
            modelBuilder.Entity("API_Pdv.Entities.Usuario", b =>
                {
                    ...
                    b.HasOne("API_Pdv.Entities.Funcionario", "Funcionario")
                        .WithMany()
